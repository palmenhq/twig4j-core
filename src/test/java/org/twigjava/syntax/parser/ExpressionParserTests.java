...
import org.twigjava.syntax.operator.UnaryNot;
...
import org.twigjava.syntax.parser.node.type.expression.BinaryAdd;
import org.twigjava.syntax.parser.node.type.expression.BinaryConcat;
import org.twigjava.syntax.parser.node.type.expression.BinaryMultiply;
import org.twigjava.syntax.parser.node.type.expression.Filter;
...
public class ExpressionParserTests {
    ...
    public void testParsePrimaryExpressionInverseBool() throws SyntaxErrorException, TwigRuntimeException {
        ...
        Node expectedNode = new org.twigjava.syntax.parser.node.type.expression.UnaryNot(new Constant(true, 1), 1);
    ...
    public void canParseFilters() throws SyntaxErrorException, TwigRuntimeException {
        ...
        try {
            when(environment.getFilter("upper")).thenReturn(new org.twigjava.filter.Filter("upper", getClass().getMethod("activateUpperFilter", String.class)));
    ...
    public void canParseParentFunction() throws SyntaxErrorException, TwigRuntimeException {
        ...
        parser.setParent(new StringConstant("foo.twigjava", 1));
        parser.setTokenStream(tokenStream);
        ExpressionParser expressionParser = new ExpressionParser(parser);
