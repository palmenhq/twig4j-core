...
public class TwigException extends Exception {
    ...
    /**
     * Create a twigjava exception without any template info
    ...
    /**
     * Create a twigjava exception with file name included
     * @param rawMessage The error message
    ...
    /**
     * Create a twigjava exception with file name and line number included
     * @param rawMessage The error message
     * @param templateName The filename the error occurred in
